...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var stepperSpeed:FlxUINumericStepper = new FlxUINumericStepper(stepperBPM.x, stepperBPM.y + stepperBPM.height + 16, 0.1, 1, 0.1, 10, 1);
		...
		var check_mute_inst = new FlxUICheckBox(stageDropDown.x, stageDropDown.y + (stageDropDown.height * 2), null, null, "Mute Instrumental (in editor)",
			100);
		...
		tab_group_song.add(new FlxText(stepperBPM.x, stepperBPM.y - 16, 0, "BPM", 8));
		tab_group_song.add(stepperBPM);
		tab_group_song.add(new FlxText(stepperSpeed.x, stepperSpeed.y - 16, 0, "Song Speed", 8));
	...
	function loadSong(daSong:String):Void
	{
		...
		FlxG.sound.playMusic(daSong.inst(), 0.6);

		// WONT WORK FOR TUTORIAL OR TEST SONG!!! REDO LATER
		vocals = new FlxSound().loadEmbedded(daSong.voices());
	...
	{
		PlayState.SONG = Song.loadFromJson(song.toLowerCase(), Highscore.formatSong(song.toLowerCase(), PlayState.storyDifficulty));
		FlxG.resetState();
	}
