...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic('menuBG'.image());
		bg.scrollFactor.x = 0;
		...
		magenta = new FlxSprite(-80).loadGraphic('menuDesat'.image());
		...
		var tex = 'FNF_main_menu_assets'.getSparrowAtlas();
